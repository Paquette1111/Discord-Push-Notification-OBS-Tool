...
<div class="bg-[#2b2e38] w-full h-[100vh] gap-2 flex flex-col items-center justify-center p-5">
    <input on:change={updateSettings} type="password" bind:value={settings.id} placeholder="Bot Secret" class="input w-full max-w-2xl border-2 border-neutral-100 rounded-[4px] px-2 py-1">
    <input on:change={updateSettings} type="text" bind:value={settings.channel} placeholder="Text Channel ID" class="w-full max-w-2xl input border-2 border-neutral-100 rounded-[4px] px-2 py-1">
